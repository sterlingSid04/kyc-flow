...
const InputComponent = ({ title, placeholder, email = false, onChange }: InputComponentProps) => {
  return (
    <div className="flex flex-col items-start self-stretch gap-[0.25rem] p-[1rem_0rem_0.5rem_0rem]">
      ...
      <input
        ...
        className="flex items-center w-[22.375rem] h-[3.5rem] p-[0.5rem_1rem] gap-[0.625rem] flex-shrink-0 rounded-[0.25rem] border border-[#8E959F] bg-white"
      />
    </div>
  );
};
